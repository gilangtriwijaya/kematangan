...
<div class="container py-4">
    <h4 class="mb-4">Tambah Indikator Penilaian</h4>
    ...
    <form action="{{ route('indikator.store') }}" method="POST" class="card p-4 shadow-sm">
        @csrf
        ...
        <div class="mb-4">
            ...
            <input type="number" name="jumlah_bukti" id="jumlah_bukti" value="{{ old('jumlah_bukti') }}" class="form-control" min="0" required>
        </div>
